...
use Shopping\OpenSDK\TaoBao\Application as TaoBao;
use Shopping\OpenSDK\PinDuoDuo\Application as PinDuoDuo;
use Shopping\OpenSDK\JingDong\Application as JingDong;
use Shopping\OpenSDK\SuNing\Application as SuNing;
...
class Factory
{
    ...
    {
        if (!in_array ($name, ['taobao', 'jingdong', 'pinduoduo','suning'])) {
